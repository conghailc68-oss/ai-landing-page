...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-20 pb-8 px-4 overflow-hidden border-t border-white/5">
      {/* Ambient */}
      <div className="orb w-[400px] h-[200px] bg-purple-500/6 bottom-0 left-1/2 -translate-x-1/2" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
              ...
              {quickLinks.map((link, i) => (
                <li key={i}>
                  ...
                  >
                    <ChevronRight
                      size={14}
                      className="opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300 text-cyan-400"
                    />
                    {link.label}
                  </button>
                </li>
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                <FacebookIcon size={16} className="text-blue-400 shrink-0" />
                <a
                  href="#"
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="glass rounded-xl p-3 border border-green-400/20 mt-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-600 text-xs">
            Designed by{' '}
            <span className="text-slate-400 font-medium">Hai Cong</span>
          </p>
        </div>
      </div>
    </footer>
