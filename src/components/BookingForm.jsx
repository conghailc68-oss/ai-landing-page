...
export default function BookingForm() {
  ...
  return (
    <section id="booking" className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 overflow-hidden">
      <div className="orb w-[350px] h-[350px] sm:w-[500px] sm:h-[500px] bg-purple-500/8 top-0 right-0" />
      <div className="orb w-[280px] h-[280px] sm:w-[400px] sm:h-[400px] bg-cyan-500/6 bottom-0 left-0" />
      ...
      <div className="max-w-xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="glass rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-white/8 shadow-[0_0_60px_rgba(0,212,255,0.05)]"
        >
          <AnimatePresence mode="wait">
            {success ? (
              ...
              >
                ...
                <h3 className="section-title text-xl sm:text-2xl font-bold text-white mb-2">
                  Đặt hàng thành công!
                </h3>
                <p className="text-slate-400 text-sm sm:text-base">
                  Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất.
                </p>
                <div className="mt-4 glass rounded-xl px-5 py-2.5 border border-green-400/20">
                  <span className="text-green-400 text-sm font-medium">✓ Đơn hàng đã được ghi nhận</span>
                </div>
              </motion.div>
            ) : (
              <motion.form
              ...
              >
                ...
                <div>
                  ...
                  {errors.appId && <p className="text-red-400 text-xs mt-1">{errors.appId}</p>}
                </div>
                ...
                <motion.button
                  ...
                  className="btn-neon w-full flex items-center justify-center gap-3 py-3.5 sm:py-4 text-sm sm:text-base font-bold rounded-xl disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {loading ? (
