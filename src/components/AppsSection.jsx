...
export default function AppsSection() {
  return (
    <section id="apps" className="relative py-24 px-4 overflow-hidden">
      {/* Ambient */}
      <div className="orb w-[400px] h-[400px] bg-purple-500/8 top-0 right-0" />
      <div className="orb w-[300px] h-[300px] bg-cyan-500/6 bottom-0 left-0" />
